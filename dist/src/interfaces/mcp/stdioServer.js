...
server.prompt("get_adaptive_persona", {
...
server.tool("harvest_idiom_delta", {
    userId: z.string().min(1),
    personaName: z.string().min(1),
    term: z.string().min(1),
...
server.resource("persona-archetype-delta", new ResourceTemplate("persona://archetypes/{personaName}", { list: undefined }), {
